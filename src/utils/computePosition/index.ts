import {ComputePosition} from "@/utils/types/computePosition";
import {Middleware, MiddlewareData} from "@/utils/types/extension";
import {computeCoordsFromPlacement} from "@/utils/computeCoordsFromPlacement";


export const index: ComputePosition = async (
    reference,
    floating,
    config,
) => {
